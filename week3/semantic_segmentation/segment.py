...
args = {'model': 'enet-cityscapes/enet-model.net', 'classes': 'enet-cityscapes/enet-classes.txt', \
		'colors': 'enet-cityscapes/enet-colors.txt', 'image': 'images/gsv_0.jpg', 'width': 500}
